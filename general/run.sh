...
python3 run.py --checkpoint facebook/opt-13b --compute-device cuda:0 --normal-loop --prompt-len 128 --gen-len 32 --gpu-batch-size 8 --num-gpu-batches 20 --percent 20 30 0 25 0 100  
