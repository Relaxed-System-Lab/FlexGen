...
nsys profile -o prof.qdrep --force-overwrite true python3 -c \
 "import os; os.system(\"python3 run.py --checkpoint facebook/opt-13b --compute-device cuda:0 --prompt-len 32 --gen-len 3 --gpu-batch-size 32 --num-gpu-batches 10 --percent 20 30 0 25 100 0 \")"
...
python3 run.py --checkpoint facebook/opt-13b --compute-device cuda:0 --prompt-len 32 --gen-len 3 --gpu-batch-size 32 --num-gpu-batches 10 --percent 20 30 0 25 100 0 
