# nsys profile
nsys profile -o prof.qdrep --force-overwrite true python3 run.py 

nsys profile -o prof.qdrep --force-overwrite true python3 -c \
 "import os; os.system(\"python3 run.py --checkpoint facebook/opt-13b --compute-device cuda:0 --prompt-len 128 --gen-len 3 --gpu-batch-size 32 --num-gpu-batches 10 --percent 20 30 0 25 100 0 \")"
...
python3 run.py --checkpoint facebook/opt-1.3b --compute-device cuda:0 --prompt-len 128 --gen-len 32 --gpu-batch-size 32 --num-gpu-batches 10 --percent 20 30 0 25 100 0 

python3 run.py --checkpoint facebook/opt-13b --compute-device cuda:0 --prompt-len 128 --gen-len 3 --gpu-batch-size 32 --num-gpu-batches 10 --percent 20 30 0 25 100 0 
